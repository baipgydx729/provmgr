...
public class Table1_6Util {
     ...
     */
    private static int TOTAL_COLUMNS = 7;
     ...
     * @throws Exception
     */
    public static File createExcelFile(String templateFile, String targetFileName,
        ...
        try {
            ...
            //填写预设单元格的内容
            writePresetContent(sheetOut, writeUserName, checkUserName);
            //填写数据
    ...
    private static void writeData(HSSFSheet sheet, List<DataTable1_6> dataList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int j = 1; j <= TOTAL_COLUMNS; j++) {
                Double value = getDoubleDataByColumnIndex(dataTable1_6, j);
     ...
     * @return
     */
    public static Double getDoubleDataByColumnIndex(DataTable1_6 dataTable1_6, int index) {
        switch (index) {
            case 1:
                return dataTable1_6.getE01();
            case 2:
                return dataTable1_6.getE02();
            case 3:
                return dataTable1_6.getE03();
            case 4:
                return dataTable1_6.getE04();
            case 5:
                return dataTable1_6.getE05();
            case 6:
                return dataTable1_6.getE06();
            default:
                return 0.0;
        }
    }
