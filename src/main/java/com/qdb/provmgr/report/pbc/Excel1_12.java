 ...
 * @author mashengli
 */
public class Excel1_12 extends ReportExcelUtil {
    /**
     * 数据起始行数下标（下标从0开始）
     */
    ...
    private void writeData(HSSFSheet sheet, List<BaseReportEntity> dataList) {
        ...
        for (int i = 0; i < size; i++) {
            DataTable1_12 dataTable1_12 = (DataTable1_12)dataList.get(i);
     ...
     * @return
     */
    public BigDecimal getDoubleDataByRowIndex(DataTable1_12 dataTable1_12, int index) {
        switch (index) {
            case 4:
