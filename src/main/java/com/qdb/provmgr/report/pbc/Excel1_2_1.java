 ...
 * @author mashengli
 */
public class Excel1_2_1 extends ReportExcelUtil {

    private static Logger log = LoggerFactory.getLogger(Excel1_2_1.class);
     ...
     * 数据区域结束行数下标（下标从0开始）
     */
    private static int DATA_END_ROW_NUM = 44;
     ...
     * @return
     */
    private BigDecimal getDoubleDataByColumnIndex(DataTable1_2 dataTable1_2, int index) {
        switch (index) {
            case 1:
