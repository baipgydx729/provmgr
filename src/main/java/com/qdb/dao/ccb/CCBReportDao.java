...
public class CCBReportDao {
     ...
     * @return
     */
    public List<Map<String, Object>> queryDataList(String tableType, String bankName, String accountNo, String beginDate, String endDate){
        StringBuffer sqlBuf = this.buildBaseSql(tableType, bankName, accountNo, beginDate, endDate);
        Object[] params = this.buildParams(bankName, accountNo, beginDate, endDate);
     ...
     * @return 参数数组
     */
    private Object[] buildParams(String bankName, String accountNo, String beginDate, String endDate) {
